    ...
    <div style="background:white;border-radius:12px;padding:2rem;margin-top:1rem;box-shadow:0 2px 8px rgba(0,0,0,.06);">
        <form action="{{ route('admin.questions.store') }}" method="POST">
            ...
            <div style="display:flex;gap:1rem;margin-top:1.5rem;">
                <button type="submit" style="background:var(--orange);color:white;padding:.7rem 2rem;border-radius:8px;border:none;cursor:pointer;font-weight:700;">Créer la question</button>
