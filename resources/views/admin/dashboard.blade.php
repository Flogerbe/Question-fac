...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">
    ...
    <div style="background:white;border-radius:12px;padding:1.5rem;box-shadow:0 2px 8px rgba(0,0,0,.06);">
        ...
        <div style="display:flex;flex-direction:column;gap:.8rem;">
            ...
            <a href="{{ route('admin.settings.index') }}#maintenance" style="background:#f0f3f7;color:#334155;padding:.7rem 1rem;border-radius:8px;text-decoration:none;font-size:.9rem;text-align:center;border:1px solid #334155;">🔧 Maintenance serveur</a>
        </div>
    </div>
</div>
@endsection
